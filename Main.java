...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GeneticAlgorithm ga = new GeneticAlgorithm(board, numOfGeneration, populationSize, mutationRate, crossoverRate,
                elitismCount);
    ...
    String TestCase
        ...
        try {
            ...
            // String[] header = { "Population Size","Mutation Rate", "Crossover Rate", "Number of Generations","Number of Elitism", "Best Chromosome", "Fitness Chromosome","Max fitness", "Test Case" };
            // writer.writeNext(header);

            // add data to csv
            String[] data1 = { PopulationSize, MutationRate, CrossoverRate, NumberOfGenerations, NumberOfElitism,BestChromosome,FitnessChromosome,Maxfitness,TestCase};
